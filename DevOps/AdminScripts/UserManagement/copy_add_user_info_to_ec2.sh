...
if [ $# -lt 5 ]; then
	echo ""
	echo ""	
	echo "Usage:   sudo $0 instance_access_ssh_key  ec2_user_name ec2_dns_machine_string   instance_access_ssh_key path_to_rdi_scripts"
	echo ""
	...
	echo "user_ssh_public_key	-	full path to the user generated public key "
...
ec2_dns_machine_string=$3
user_ssh_public_key=$4
path_to_rdi_scripts=$5
scp -i $instance_access_ssh_key $user_ssh_public_key $ec2_initial_user_name@ec2_dns_machine_string:/home/$ec2_initial_user_name/
